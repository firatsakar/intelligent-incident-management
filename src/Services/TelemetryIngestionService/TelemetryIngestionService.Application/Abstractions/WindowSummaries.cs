...
/// Every count is of events, not rows: each sums <c>LogRecord.Occurrences</c>, so a storm folded
/// onto ten samples still reads as the three hundred events it was.
